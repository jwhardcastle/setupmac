...
a machine (Mac or Ubuntu) to how I like it.

To setup run the following command :
```
curl -s https://raw.githubusercontent.com/jwhardcastle/setupmachine/master/start.sh | /bin/bash
```
...
what get's installed at [here](https://raw.githubusercontent.com/jwhardcastle/setupmachine/master/roles/setup/vars/main.yml). If you want to change the list of applications, clone
...
If you want to undo all the changes that `setupmachine` did, run 
